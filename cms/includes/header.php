...
<head>
    ...
    <title><?php echo $pageTitle ?? 'Dashboard'; ?> - CMS Petersen</title>
    ...
    <div class="admin-wrapper">
        <aside class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="catalogs.php" class="<?php echo $currentPage === 'catalogs' || $currentPage === 'catalog-leads' ? 'active' : ''; ?>">
                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                    <a href="feria.php" class="<?php echo $currentPage === 'feria' ? 'active' : ''; ?>">
                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                    <a href="form-settings.php" class="<?php echo $currentPage === 'form-settings' ? 'active' : ''; ?>">
                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                        </svg>
                ...
                <li>
                    <a href="site-options.php" class="<?php echo $currentPage === 'site-options' ? 'active' : ''; ?>">
                        <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <main class="main-content">
            <div class="top-bar">
                <div>
                    <h3>Bienvenido, <?php echo htmlspecialchars($currentUser['full_name']); ?></h3>
                </div>
                <div class="user-info">
